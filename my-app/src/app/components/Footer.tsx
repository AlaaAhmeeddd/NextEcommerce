...
export default function Footer() {
    return (
        <div>
            ...
            <footer className="flex flex-col gap-y-6 items-center justify-center bg-primary pb-16">
                <aside className="flex flex-col gap-y-6">
                    <h1 className="text-3xl font-bold text-center">Next<span className="text-white">Commerce</span></h1>
